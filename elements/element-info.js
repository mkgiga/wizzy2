...
export default function elementInfo({ targetElement }) {
  ...
  const materialIconName = getMaterialIcon(target.tagName);
  ...
  const el = html`
    <div class="__wizzy-element-info">
      ...
      <span class="material-icons __wizzy-element-icon"
        >${materialIconName}</span
      >
      <p class="__wizzy-element-info-tag">
        &lt;${target.tagName.toLowerCase()}&gt;
      </p>
      <div class="__wizzy-element-info-edit" collapsed>
        <span class="material-icons">edit_attributes</span>
        <p
          class="__wizzy-element-info-attributes"
          contenteditable
          spellcheck="false"
        ></p>
        <span class="material-icons">info</span>
        <p class="__wizzy-element-info-class" contenteditable>
          ${target.className}
        </p>
        <span class="material-icons">style</span>
        <p class="__wizzy-element-info-style" contenteditable>
          ${target.style.cssText}
        </p>
        <button class="material-icons __wizzy-element-info-edit-expand">
          chevron_right
        </button>
      </div>
    </div>
  ...
  const collapse = () => {
    if (editContainer.hasAttribute("collapsed")) {
      el.querySelector(".__wizzy-element-info-attributes").textContent =
        getAttributesString();
      el.querySelector(".__wizzy-element-info-class").textContent =
        getClassString();
      el.querySelector(".__wizzy-element-info-style").textContent =
        getStyleString();
